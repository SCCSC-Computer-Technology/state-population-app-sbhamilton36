...
namespace shamilton_Lab_3
{
    ...
    public partial class Details : Form
    {
        ...
        {
            // When user clicks a header, show our custom filter menu
            shamilton_Lab_4_ClassLibrary.AutoFilter.AddFilters(statesDataGridView, statesBindingSource, e.ColumnIndex);
        }
